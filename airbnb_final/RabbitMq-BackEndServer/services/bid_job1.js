...
exports.bid_job = {
    ...
    job: function (req, res) {
        ...
        var output = '';
        var id = '';
        var bidEndTimeChk = "Select property_id from property where Bid_Time <= CURRENT_TIMESTAMP and bidstate = '1';";
                        ...
                        mysql.fetchData(function (err, results) {
                            if (err) {
                                ...
                                for (var x in results) {
                                    var insMess = "INSERT INTO host_message (host_id,checkin,checkout,UserName,user_id,bill_id,guest, total,price) Select host_id,from_date,to_date ,user_fname,user_id,bill_id,no_guest,total,price from bill where bill_id = " + 38 +";";
                                    mysql.fetchData(function (err, results) {
                                        if (err) {
                                            throw err;
                                        }
